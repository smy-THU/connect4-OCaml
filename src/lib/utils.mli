...
(** [point_is_in point board] checks if a given point is within the bounds of
    the board.
...
(** [empty_board rows cols] creates an empty game board with the given
    dimensions. All cells are initialized to 0.
